...
//  Pairs
//
//  Created by Ramit sharma on 17/04/20.
...
class Deck: ObservableObject {
    let allCards: [Card] = Bundle.main.decode("maths.json")
...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(gradient: Gradient(colors: [Color(white: 0.7), .yellow]), startPoint: .top, endPoint: .bottom)
        VStack {
            Image(decorative: "Pair")
